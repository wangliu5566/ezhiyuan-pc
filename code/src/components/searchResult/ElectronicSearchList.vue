<template>
  <div class="electronic-search" @click="isHistorySearchShow = false;conMenuShow = false">
  ...
  data () {
    return {
      ...
      loading:true,
       ...
       pageSize:10,
       tableData: [],
       searchKey:this.$route.query.searchKey || this.$route.query.id || GetArgument().split('=')[1],
       newSearchKey:'',
       conMenuShow:false,
      contextEvent:null,
    }
